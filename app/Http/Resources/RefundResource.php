...
class RefundResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'buyer_role' => $this->purchase->user->role,
            'buyer_student_id' => $this->purchase->user->student ? $this->purchase->user->student->student_id:null,
            'buyer_staff_id' => $this->purchase->user->staff ? $this->purchase->user->staff->staff_id:null,
